...
class NewVisitorTest(LiveServerTestCase):
	...
	def check_for_row_in_the_list(self, row_text):
	...
	def test_can_start_a_list_and_retrieve_it_later(self):
		...
		# enters "Use peacock feathers to make fly" (Edith is very
		# methodical)
	...
	def test_layout_and_styling(self):
		...
		# She starts a new list and sees the input is still nicely
		# centered there too
